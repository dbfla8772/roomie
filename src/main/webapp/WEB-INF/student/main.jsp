...
<div class="container">
    ...
    <div class="nav-scroller py-1 mb-2">
        <nav class="nav d-flex justify-content-between">
            ...
            <a class="p-2 link-secondary" href="${pageContext.request.contextPath}/mail/receiveList" target="_blank" onclick="window.open(this.href, '','width=400, height=430'); return false;">쪽지</a>
