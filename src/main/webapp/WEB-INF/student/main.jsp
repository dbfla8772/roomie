...
<span id="top"><div class="w-auto p-2" style="background-color: lightcyan; text-align: center;"><h4 style="font-family: SBAggroL">당신의 루미를 찾아보세요! <button class="btn btn-outline-success" type="submit" onClick="location.href='/student/automatch'">자동매칭 하러가기</button></h4></div></span>
<div class="container">
...
<div onclick="goTop()" style="position: fixed; bottom: 5px; right: 5px; cursor: pointer;">
    <a href="#top"><img src="/images/btnTop2.png" title="위로가기"></a>
</div>
</body>
</html>
